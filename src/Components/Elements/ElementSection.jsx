...
const ElementSection = ({ className }) => {
    ...
    useEffect(() => {
        ...
        const initSimulation = () => {
            ...
            // Use deterministic pseudo-random sequence so server & client initial HTML remain stable (animation applies only after mount).
            setTimeout(() => {
                let seed = 123456789;
                const rand = () => {
                    // Simple LCG for repeatable sequence
                    seed = (seed * 1664525 + 1013904223) % 4294967296;
                    return seed / 4294967296; // 0..1
                };
                tags.forEach((tag) => {
                    const forceX = (rand() - 0.5) * 0.05;
                    const forceY = -0.05 - rand() * 0.02;
